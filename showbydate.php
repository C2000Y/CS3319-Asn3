...
include 'connectdb.php';
	...
	$date=$year."-".$month."-".$day;
	?>
	<h1 style="text-align:center;">Before <?php echo "{$year}-{$month}-{$day}"; ?></h1>
	<p><hr><p>
	<body>
